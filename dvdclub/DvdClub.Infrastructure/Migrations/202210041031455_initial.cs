    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .Index(t => t.Id, name: "FullNameIndex")
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.KRATHSH", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.KRATHSH", "CopyId", "dbo.Copies");
            ...
            DropIndex("dbo.AspNetUsers", "FullNameIndex");
            DropIndex("dbo.KRATHSH", new[] { "UserId" });
            DropIndex("dbo.KRATHSH", new[] { "CopyId" });
